  ...
  public: {
    Tables: {
      delivery_executives: {
        ...
        Relationships: [
          {
            foreignKeyName: "delivery_executives_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
      ...
      orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "orders_delivery_exec_id_fkey"
            columns: ["delivery_exec_id"]
            isOneToOne: false
            referencedRelation: "delivery_executives"
            referencedColumns: ["id"]
          },
          {
